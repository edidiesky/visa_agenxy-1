    ...
    <PlansContent>
      <div className="w-90 auto container">
        <div className="w-100 center hidden">
          <h2
            className="text-bold w-100 center fs-40"
            data-aos="fade-up"
            data-aos-duration="1100"
            data-aos-delay="200"
          >
            Passport Plans
            <span className="block fs-16 text-light text-grey family-1 pt-2">
            ...
            return (
              ...
              >
                    ...
                    return (
                      <div className="w-100 hidden">
                        <li
                          ...
                          className="w-80 fs-14 text-light center border-bottom py-1 auto"
                        >
                          {x}
                        </li>
                      </div>
                ...
                <div className="w-100 py-2 pb-3 flex item-center justify-center hidden">
                  <button
                    className="btn fs-14 family1 text-light"
                    data-aos="fade-up"
                    data-aos-duration="1100"
                    data-aos-delay="600"
                  >
