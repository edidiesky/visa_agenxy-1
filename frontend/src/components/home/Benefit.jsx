      ...
      <BenefitContent>
        <div className="container">
          <div className="w-100 hidden">
            <h2
              className="font-weight-bold fs-30 text-color-dark mb-3 hidden"
              data-aos="fade-up"
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="feature-box-info">
                        <h4 className="font-weight-normal fs-16 text-5">
                          {" "}
                          {x.title}
                        </h4>
                        <p className="text-2 fs-12">{x.desc}</p>
                      </div>
                    </div>
                  </Link>
                </div>
      ...
      <BenefitTop1Wrapper>
        <div className="container">
          <div className="row">
            <div className="w-100 hidden">
              <h2
                className="font-weight-bold fs-30 text-color-dark"
                data-aos="fade-up"
